...
// Сквозной поиск компаний по ВСЕЙ базе (независимо от выбранной сферы) —
// по названию компании ИЛИ по e-mail. Возвращает и название сферы для метки.
...
<link href="https://fonts.googleapis.com/css2?family=Montserrat:wght@400;500;600;700&display=swap" rel="stylesheet"></head>
<body style="margin:0;padding:0;background:#eef0f5;-webkit-text-size-adjust:100%;font-family:'Montserrat',Arial,Helvetica,sans-serif">
<table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%" style="background:#eef0f5">
 <tr><td align="center" style="padding:24px 12px">
  <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="640" style="max-width:640px;width:100%;background:#ffffff;border-radius:14px;overflow:hidden;box-shadow:0 2px 12px rgba(20,25,40,.07)">
   <!-- Тело -->
   <tr><td style="padding:34px 36px 10px;font-family:'Montserrat',Arial,Helvetica,sans-serif;color:#2a2f3a;font-size:15px;line-height:1.7">
     ${bodyHtml}
