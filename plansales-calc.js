...
const DEPT_ORDER = ['Элементный', 'Хроматография и клеточный анализ', 'Электрохимия', 'Расходники', 'Сервис', 'General Lab', 'Обучение', 'Комплекс', 'Материаловедение', 'Инструменты'];
